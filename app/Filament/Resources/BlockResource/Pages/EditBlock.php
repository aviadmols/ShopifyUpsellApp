...
class EditBlock extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        $reserved = [
            ...
            'cart_wide_enabled', 'cart_wide_headline', 'cart_wide_subtext', 'cart_wide_frequency',
            'cart_wide_success_headline', 'cart_wide_undo_label', 'cart_wide_undo_style', 'cart_wide_cta_label',
            'cart_wide_required_attributes', 'cart_wide_mappings',
            'ui',
