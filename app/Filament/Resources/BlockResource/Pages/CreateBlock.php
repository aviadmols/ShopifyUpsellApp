...
class CreateBlock extends CreateRecord
{
    ...
    public static function buildBlockConfig(array $data): array
    {
        ...
        if ($surface === 'checkout' && $type === 'upsell') {
            ...
            $config = [
                ...
                'ui' => [
                    'display_mode' => (string) ($data['upgrade_card_display_mode'] ?? 'text'),
                    'image_url' => trim((string) ($data['upgrade_card_image_url'] ?? '')),
                    'title_size' => (string) ($data['upgrade_card_title_size'] ?? 'medium'),
                ...
                'cart_wide_undo_style' => in_array((string) ($data['upgrade_card_cart_wide_undo_style'] ?? 'plain'), ['plain', 'secondary', 'primary'], true) ? (string) $data['upgrade_card_cart_wide_undo_style'] : 'plain',
    ...
    public static function getStateFromGet(\Filament\Forms\Get $get): array
    {
        $keys = [
            ...
            'upgrade_card_cart_wide_success_headline', 'upgrade_card_cart_wide_undo_label', 'upgrade_card_cart_wide_undo_style', 'upgrade_card_cart_wide_cta_label',
