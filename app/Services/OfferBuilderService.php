...
class OfferBuilderService
{
    ...
    protected function buildSingleCondition(string $field, mixed $value): ?array
    {
        return match ($field) {
            ...
            'checkout_attribute_equals' => ['checkout_attribute_equals' => (string) $value],
            'checkout_attribute_not_equals' => ['checkout_attribute_not_equals' => (string) $value],
            'checkout_attribute_contains' => ['checkout_attribute_contains' => (string) $value],
            'checkout_attribute_exists' => ['checkout_attribute_exists' => (string) $value],
