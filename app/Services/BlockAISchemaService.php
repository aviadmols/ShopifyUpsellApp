...
class BlockAISchemaService
{
    ...
    private function ruleConditions(): array
    {
        return [
            ...
            ['field' => 'checkout_attribute_equals', 'value_format' => 'key,value', 'description' => 'Checkout/cart attribute equals (set on storefront or in checkout)'],
            ['field' => 'checkout_attribute_not_equals', 'value_format' => 'key,value', 'description' => 'Checkout/cart attribute does not equal (or key missing)'],
            ['field' => 'checkout_attribute_contains', 'value_format' => 'key,substring', 'description' => 'Checkout/cart attribute contains'],
            ['field' => 'checkout_attribute_exists', 'value_format' => 'key', 'description' => 'Checkout/cart attribute exists (any value)'],
            ['field' => 'line_items_has_line_without_selling_plan', 'value_format' => 'none (use as boolean)', 'description' => 'At least one cart line has NO selling plan (selling_plan_id null) — one-time purchase. Use this for "only when cart has one-time items" or "no subscription".'],
            ['field' => 'line_items_has_line_with_selling_plan', 'value_format' => 'none (use as boolean)', 'description' => 'At least one cart line HAS a selling plan (selling_plan_id set) — subscription. Use this for "only when cart has subscription items".'],
            ['field' => 'line_item_property_equals', 'value_format' => 'key,value', 'description' => 'Line item custom property equals (e.g. Dog Name, gift message). Do NOT use for subscription/selling plan — use line_items_has_line_without_selling_plan or line_items_has_line_with_selling_plan instead.'],
